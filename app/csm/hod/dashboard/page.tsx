...
export default async function CSMHODDashboard() {
  // Verify access
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">CSM HOD Dashboard</h1>
            <p className="text-gray-600 mt-2">
              Welcome back, {official.display_name}. Manage CSM department club applications.
            </p>
          </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">CSM</p>
                </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm border">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Review and approve club applications from CSM department students.
              </p>
              <Link href="/csm/hod/club-applications">
