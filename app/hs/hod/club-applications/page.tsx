...
export default async function HSHODClubApplications() {
  // Verify access
  ...
  const applications = await getCategorizedApplications('hs_hod', 'hs');
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">H&S Club Applications</h1>
            <p className="text-gray-600 mt-2">
              Review and manage club applications from H&S department students.
            </p>
          </div>
