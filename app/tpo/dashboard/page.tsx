...
export default async function TPODashboard() {
  // Verify access
  const hasAccess = await verifyOfficialAccess('tpo');
  if (!hasAccess) {
    redirect('/sign-in');
  }
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">TPO</p>
                </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm border">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Review and approve club applications from all departments as the Training & Placement Officer.
              </p>
              <Link href="/tpo/club-applications">
