...
export default async function TPOClubApplications() {
  // Verify access
  ...
  // Get categorized applications (all departments for TPO)
  const applications = await getCategorizedApplications('tpo');
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Review and manage club applications from all departments as TPO.
            </p>
          </div>
