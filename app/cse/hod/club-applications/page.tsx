...
export default async function CSEHODClubApplications() {
  // Verify access
  ...
  // Get applications for all departments
  const applications = await getCategorizedApplications('cse_hod', 'cse');
