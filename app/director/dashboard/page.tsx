...
import { FileText, Users, TrendingUp, Crown } from "lucide-react";
import Link from "next/link";

export default async function DirectorDashboard() {
  // Verify access
  const hasAccess = await verifyOfficialAccess('director');
  if (!hasAccess) {
    redirect('/sign-in');
  }
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Welcome back, {official.display_name}. Review club applications from all departments.
            </p>
          </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">Director</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">All Depts</p>
                </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm border">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Review and approve club applications from all departments as the Director.
              </p>
              <Link href="/director/club-applications">
