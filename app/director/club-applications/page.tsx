...
export default async function DirectorClubApplications() {
  // Verify access
  ...
  // Get categorized applications (all departments for Director)
  const applications = await getCategorizedApplications('director');
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Review and manage club applications from all departments as Director.
            </p>
          </div>
